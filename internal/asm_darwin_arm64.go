...
//
// Register mapping (Darwin ARM64 ABI):
//   - X16: syscall number (num)
//   - X0:  arg1 (a1)
//   - X1:  arg2 (a2)
//   - X2:  arg3 (a3)
//   - X3:  arg4 (a4)
...
//
// On Darwin, the carry flag indicates an error condition.
// When carry is set, X0 contains the errno value.
//
//go:noescape
