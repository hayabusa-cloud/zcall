...
func Mmap(addr unsafe.Pointer, length, prot, flags, fd uintptr, offset int64) (xaddr uintptr, errno uintptr) {
	return Syscall6(SYS_MMAP, uintptr(noescape(addr)), length, prot, flags, fd, uintptr(offset))
}
